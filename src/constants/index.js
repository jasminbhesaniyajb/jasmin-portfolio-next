...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: "/images/makro_pro_mobile_app.webp",
  ...
  },
  {
    ...
    title: "Makro PRO Web",
    description: "This is a mobile application and Ecommerce app for android and ios. This app is use for online shopping or buying products and used to give customer access to online food orders.",
    image: "/images/makro_pro_web.webp",
  ...
  {
    id: 6,
    title: "BetterOpenSource",
    description: "BetterOpenSource is a curated directory that helps developers and teams discover and compare open-source alternatives to proprietary software. It features 76+ hand-reviewed tools across 16 categories with side-by-side comparisons of features, licenses, and live GitHub activity, plus command-palette search, trending tools, and community submissions — helping users avoid vendor lock-in and cut subscription costs while keeping control of their data.",
    image: "/images/betteropensource.webp",
    liveUrl: "https://betteropensource.jasminbhesaniya.com/",
    // githubUrl: "",
    techStack: ["Next.js", "Tailwind CSS", "Shadcn ui", "GitHub API"],
