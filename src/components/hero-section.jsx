    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          {/* Name */}
          <h1 className="mb-6">
            <span className="block text-4xl sm:text-5xl lg:text-7xl font-bold mb-2 animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="mb-8 h-16 flex items-center justify-center">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-neutral-700 dark:text-neutral-300 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
          ...
          {/* Description */}
          <p className="max-w-3xl mx-auto text-lg sm:text-xl text-neutral-600 dark:text-neutral-400 leading-relaxed mb-10 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            Passionate about creating beautiful, responsive web applications with 5+ years of experience in 
            <span className="font-semibold text-primary-600 dark:text-primary-400"> React.js, Next.js, and modern frontend technologies</span>. 
            Currently expanding into full-stack development while mentoring the next generation of developers.
          </p>
